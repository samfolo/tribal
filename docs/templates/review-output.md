...
| Server | `docs/internal/mcp-server.md` |
| Tools | `docs/internal/mcp-tool-surface.md` |
| Conventions | `docs/internal/conventions.md` |
| Milestones | `docs/internal/implementation-milestones.md` |
| M4 | `docs/internal/m4-write-path-pipeline.md` |
| M5 | `docs/internal/m5-mcp-server.md` |
| M6 | `docs/internal/m6-runtime.md` |
| M7 | `docs/internal/m7-auth.md` |
...
**Branch name:** For ticket reviews, check with `gh` whether a branch exists before defaulting to `*[No branch]*`. For plan and code reviews, the branch should always be known.
