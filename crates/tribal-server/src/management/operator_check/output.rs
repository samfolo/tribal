...
pub use tribal_wire::operator_check::{CheckReport as CheckOutput, CheckResult};
...
pub(in crate::management::operator_check) use human::write_human;
#[cfg(feature = "test-helpers")]
pub(in crate::management::operator_check) use json::write_json;

// ---------------------------------------------------------------------------
// Projection
// ---------------------------------------------------------------------------

pub(in crate::management::operator_check) fn from_outcomes(
