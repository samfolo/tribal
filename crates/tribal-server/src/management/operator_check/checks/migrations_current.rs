...
impl CheckOutcome {
    pub(in crate::management::operator_check) fn migrations_match() -> Self {
        Self::Pass {
            detail: CheckDetail::MigrationsMatch,
        }
    }

    pub(in crate::management::operator_check) fn migrations_behind(
        expected: i64,
        found: i64,
    ) -> Self {
        Self::Fail {
            detail: CheckDetail::MigrationsBehind { expected, found },
            remediation: CheckRemediation::RunDatabaseInitialise,
        }
    }

    pub(in crate::management::operator_check) fn migrations_ahead(
        expected: i64,
        found: i64,
    ) -> Self {
        Self::Fail {
    ...
    pub(in crate::management::operator_check) fn migrations_table_missing() -> Self {
        Self::Fail {
    ...
    pub(in crate::management::operator_check) fn migrations_query_failed(error: String) -> Self {
        Self::Fail {
