...
impl CheckOutcome {
    pub(in crate::management::operator_check) fn advertised_url_skipped_stdio() -> Self {
        Self::Skip {
            detail: CheckDetail::AdvertisedUrlSkippedStdio,
        }
    }

    pub(in crate::management::operator_check) fn advertised_url_reachable(
        url: String,
        status: u16,
    ) -> Self {
        Self::Pass {
    ...
    pub(in crate::management::operator_check) fn advertised_url_unreachable(
        url: String,
        error: String,
    ) -> Self {
        Self::Fail {
