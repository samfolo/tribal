...
impl CheckOutcome {
    pub(in crate::management::operator_check) fn embedding_profile_pending() -> Self {
        Self::Pass {
            detail: CheckDetail::EmbeddingProfilePending,
        }
    }

    pub(in crate::management::operator_check) fn embedding_profile_live(
    ...
    pub(in crate::management::operator_check) fn embedding_reindex_attention(
    ...
    pub(in crate::management::operator_check) fn embedding_profile_query_failed(
        error: String,
    ) -> Self {
        Self::Fail {
