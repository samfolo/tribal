...
use tribal_config::{ENV_AUTH_TOKEN, oauth_onboarding_is_url_only};
...
impl CheckOutcome {
    pub(in crate::management::operator_check) fn token_skipped_stdio() -> Self {
        Self::Skip {
            detail: CheckDetail::TokenSkippedStdio,
        }
    }

    pub(in crate::management::operator_check) fn token_verified(transport: TokenTransport) -> Self {
        Self::Pass {
            detail: CheckDetail::TokenVerified { transport },
        }
    }

    pub(in crate::management::operator_check) fn token_verification_failed(
    ...
    pub(in crate::management::operator_check) fn token_skipped_loopback_oauth() -> Self {
        Self::Skip {
    ...
    pub(in crate::management::operator_check) fn credentials_unreadable(
        error: String,
