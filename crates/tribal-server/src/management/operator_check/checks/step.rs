...
use strum::EnumIter;
use tribal_config::ProviderStage;
...
pub(in crate::management::operator_check) enum Preflight {
...
pub(in crate::management::operator_check) enum CheckStep {
    ConfigParse,
    ConfigValidate,
    DatabaseReachable,
    MigrationsCurrent,
...
impl CheckStep {
    ...
    pub(in crate::management::operator_check) fn preflight(self, state: &CheckState) -> Preflight {
        match self {
    ...
    pub(in crate::management::operator_check) async fn act(
        self,
