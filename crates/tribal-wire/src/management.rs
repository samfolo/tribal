...
pub use settings::{
    ...
    ProviderConnectionFailure, ProviderConnectionFailureKind, ProviderConnectionInput,
    ProviderConnectionMutationReceipt, ProviderConnectionProbeReceipt,
    ProviderConnectionProbeResult, ProviderConnectionProbeSkipReason,
