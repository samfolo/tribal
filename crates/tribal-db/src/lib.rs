...
pub use repositories::{
    ...
    JobStatusTransition, JobTriageSubmission,
    ...
    NewExtractionResult, NewItemObservation, NewJob, NewKnowledgeItem, NewKnowledgeItemRelation,
    RecentIngestionCursor, RecentIngestionPage, RecentIngestionSummary, RecentIngestionsQuery,
