...
pub use repositories::{
    ...
    AuthTokenRepository, DrivingTaskRef, EmbeddingIndexRepository, EmbeddingProfileRepository,
    EmbeddingRepository, EmbeddingTable, EnsurePrincipalOutcome, EnsureSystemOutcome,
    ExtractionResultRepository, GraphIdentityRepository, IndexState, IngestInsertOutcome,
    IngestJobRepository, ItemObservationRepository, JobRepository, JobStatusTransition,
    JobTriageSubmission, KnowledgeItemRepository, LocalDefaultCredential,
    LocalDefaultCredentialRepository, MigrationHeadStatus, MigrationRepository,
    NewAgentBindingVersion, NewAgentDriverTask, NewAgentThread, NewAgentThreadRecord, NewAuthToken,
    NewEmbedding, NewEmbeddingProfile, NewExtractionResult, NewGitProject, NewItemObservation,
    NewJob, NewKnowledgeItem, NewKnowledgeItemRelation, NewOauthAuthorizationCode, NewOauthClient,
    NewPrincipal, NewPromptVersion, NewReference, NewReindexQuarantine, NewReindexRun,
    NewReindexTask, NewRetrievalFeedback, NewSystemFingerprint, NewTagEmbedding, NewTask,
    ...
    PgAuthTokenRepository, PgEmbeddingIndexRepository, PgEmbeddingProfileRepository,
    PgEmbeddingRepository, PgExtractionResultRepository, PgGraphIdentityRepository,
    PgItemObservationRepository, PgJobRepository, PgKnowledgeItemRepository,
    PgLocalDefaultCredentialRepository, PgMigrationRepository, PgOauthAuthorizationCodeRepository,
    ...
    ReindexRetryWait, ReindexRunRepository, ReindexTaskRepository, ReindexTaskStateCount,
