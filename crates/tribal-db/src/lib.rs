...
pub use repositories::{
    ...
    NewItemObservation, NewJob, NewKnowledgeItem, NewKnowledgeItemRelation, NewPrincipal,
    NewProject, NewPromptVersion, NewReference, NewRetrievalFeedback, NewSystemFingerprint,
    NewTagEmbedding, NewTask, NewTokenUsage, NewTriageResult, NewTriageSimilarItemDecision,
