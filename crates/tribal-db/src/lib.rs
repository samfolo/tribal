...
pub use repositories::{
    ...
    EmbeddingRepository, EmbeddingTable, ExtractionResultRepository, IndexState,
    IngestInsertOutcome, IngestJobRepository, ItemObservationRepository, JobRepository,
    JobStatusTransition, JobTriageSubmission, KnowledgeItemRepository, LocalDefaultCredential,
    ...
    NewEmbedding, NewEmbeddingProfile, NewExtractionResult, NewItemObservation, NewJob,
    NewKnowledgeItem, NewKnowledgeItemRelation, NewOauthAuthorizationCode, NewOauthClient,
    NewPrincipal, NewProject, NewPromptVersion, NewReference, NewReindexQuarantine, NewReindexRun,
    ...
    PgJobRepository, PgKnowledgeItemRepository, PgLocalDefaultCredentialRepository,
    PgMigrationRepository, PgOauthAuthorizationCodeRepository, PgOauthClientRepository,
